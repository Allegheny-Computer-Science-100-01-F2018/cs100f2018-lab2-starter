...
GitHub repository (you must commit at least twice), [Travis CI](https://travis-ci.com/) will initialize a build
of your assignment, checking to see if it meets all of the requirements. If both
your source code and writing meet all of the established requirements, then you
will see a green &#x2714; in the listing of commits in GitHub. If your
submission does not meet the requirements, a red &#x2717; will appear instead.
Although the grading for correct usage of Travis will be lenient during the first two lab assignments, during the subsequent assignments the instructor will reduce a programmer's grade for this assignment if the red
...
```
Janyl Jumadinova Mon Sep 12 14:31:34 EST 2018
...
Starter](https://github.com/Allegheny-Computer-Science-100-01-F2018/cs100f2018-lab2-starter)
